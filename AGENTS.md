...
This project is indexed by GitNexus as **a0-worktree-plugin** (409 symbols, 587 relationships, 18 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/a0-worktree-plugin/context` | Codebase overview, check index freshness |
| `gitnexus://repo/a0-worktree-plugin/clusters` | All functional areas |
| `gitnexus://repo/a0-worktree-plugin/processes` | All execution flows |
| `gitnexus://repo/a0-worktree-plugin/process/{name}` | Step-by-step execution trace |
